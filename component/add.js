import React, { Component } from 'react'
 import { Label, Box, Button, TextInput, Pane, Combobox, TextInputField ,CornerDialog,Icon,Dialog} from 'evergreen-ui'
...
<div className="infromation">
                   <form className="f">
					...
					<div>
					<a href="/component/send.html">
					<button className="jss" tabindex="0" type="file"  >تسجيل</button>
					<button onclick="http:localhost:1234/component/send.html">Continue</button>

 </a> 
<input type="button" value="button name" onclick="./send.js" />
...
<CornerDialog
      ...
      <Button onClick={() => setState({ isShown: true })}>
        Show “Get in Touch” Corner Dialog
					...
					<button type="button" value="Submit" onClick="Call the external js file" ></button>
